              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex-1">
                  ...
                  <a
                    ...
                    className="text-sm md:text-base text-slate-700 hover:text-secondary transition-colors"
                  >
                    {COMPANY_PHONE}
                  </a>
                </div>
            ...
            <div className="flex gap-4 mb-6">
              <button
                ...
                className={`flex-1 px-4 py-2 md:py-3 rounded-lg font-semibold transition-all duration-300 text-sm md:text-base ${contactMethod === 'email'
                    ? 'bg-[#193358] text-white shadow-md'
                    : 'bg-white text-[#193358] border border-[#193358]'
                  }`}
              >
                Email
              </button>
              <button
                ...
                className={`flex-1 px-4 py-2 md:py-3 rounded-lg font-semibold transition-all duration-300 text-sm md:text-base ${contactMethod === 'whatsapp'
                    ? 'bg-[#A7833F] text-white shadow-md'
                    : 'bg-white text-[#A7833F] border border-[#A7833F]'
                  }`}
              >
                WhatsApp
              </button>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
              ...
              <div className='flex items-center justify-center w-full gap-4'>
                <div className='flex flex-col w-full'>
                  <label className="block text-sm font-semibold text-[#193358] mb-2">
                    First Name
                  </label>
                  <input
                    {...register('firstName')}
                    type="text"
                    placeholder="John"
                    className="w-full px-4 py-3 rounded-lg border-2 border-[#193358] focus:border-[#A7833F] focus:ring-2 focus:ring-[#A7833F]/20 bg-white transition-all outline-none shadow-sm"
                  />
                  {errors.firstName && (
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  maxLength={1000}
                  className="w-full px-4 py-3 rounded-lg border-2 border-[#193358] focus:border-[#A7833F] focus:ring-2 focus:ring-[#A7833F]/20 bg-white transition-all outline-none resize-none shadow-sm"
                />
                {errors.message && (
                  <p className="text-error text-xs md:text-sm mt-1 flex items-center gap-1">
                    <AlertCircle size={16} />
